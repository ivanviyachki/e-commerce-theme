...
define( 'BASEL_POST_TYPE_VERSION', '1.13' );
...
if( ! function_exists( 'basel_enqueue_scripts' ) ) {
	...
	function basel_enqueue_scripts() {
		...
		if( basel_get_opt( 'combined_js' ) ) {
			...
			wp_enqueue_script( 'basel-dayjs-index', basel_get_script_url( 'dayjs-index' ), array(), $version, true );
			wp_enqueue_script( 'basel-dayjs', basel_get_script_url( 'dayjs' ), array(), $version, true );
			wp_enqueue_script( 'basel-dayjs-utc', basel_get_script_url( 'dayjs-utc' ), array(), $version, true );
			wp_enqueue_script( 'basel-dayjs-timezone', basel_get_script_url( 'dayjs-timezone' ), array(), $version, true );
