...
<?php if (basel_needs_footer()): ?>
    ...
    <?php if( ! is_single( 'product' ) && ! is_page( 'kontakti' ) && ! is_home() && ! is_page( 'partnyori' ) && ! is_page( 'politika-za-poveritelnost' )  && ! is_single( 'post' ) ) {
        echo do_shortcode('[html_block id="18483"]');
    } ?>
